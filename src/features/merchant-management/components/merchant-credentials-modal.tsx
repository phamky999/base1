...
export const MerchantCredentialsModal = ({
  ...
  const [isConfirmRegenerateDrawerOpen, setIsConfirmRegenerateDrawerOpen] =
    useState(false);
  ...
  return (
    <>
          ...
          <>
            ...
            {hasCredentials ? (
              <Button
                ...
                onClick={() => setIsConfirmRegenerateDrawerOpen(true)}
              >
                Cấp lại
              </Button>
            ) : (
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2 rounded-lg border bg-muted/30 p-2">
                  ...
                  <Button
                    ...
                    className="size-8"
                    onClick={() =>
                      credential.apiKey && handleCopy(credential.apiKey, 'key')
                    }
                  >
                    {copiedKey ? (
      ...
      <AppConfirmModal
        open={isConfirmRegenerateDrawerOpen}
        onOpenChange={setIsConfirmRegenerateDrawerOpen}
        title="Cấp lại thông tin kết nối"
        description={`Bạn có chắc chắn muốn cấp lại thông tin kết nối API? Khóa API cũ sẽ lập tức mất hiệu lực và các tích hợp đang hoạt động có thể bị gián đoạn.`}
